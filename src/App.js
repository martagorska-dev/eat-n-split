...
function FriendsList({ friends, onSelection, selctedFriend }) {
  return (
    <ul>
      {friends.map((friend) => (
        <Friend
...
function Friend({ friend, onSelection, selctedFriend }) {
  const isSelected = friend.id === selctedFriend?.id;
...
function FormSplitBill({ selctedFriend, onSplitBill }) {
  ...
  return (
    <form className="form-split-bill" onSubmit={handleSubmit}>
      ...
      <label>👫 {selctedFriend.name}'s expense</label>
